...
function magista_customize_register( $wp_customize ) {
	...
	$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
        ...
        $wp_customize->add_setting('magista_features_icon_1', array(
            'transport' => 'postMessage',
        ));

        $wp_customize->add_control('magista_features_icon_1', array(
            'label' => __('Feature-1 Icon', 'magista'),
            'section' => 'magista_features',
            'settings' => 'magista_features_icon_1',
            'priority' => 3,
        ));
        ...
        $wp_customize->add_setting('magista_features_icon_2', array(
            'sanitize_callback' => 'sanitize_text_field',
            'transport' => 'postMessage',
        ));

        $wp_customize->add_control('magista_features_icon_2', array(
            'label' => __('Feature-2 Icon', 'magista'),
            'section' => 'magista_features',
            'settings' => 'magista_features_icon_2',
            'priority' => 6,
        ));
        ...
        $wp_customize->add_setting('magista_features_icon_3', array(
            'sanitize_callback' => 'sanitize_text_field',
            'transport' => 'postMessage',
        ));

        $wp_customize->add_control('magista_features_icon_3', array(
            'label' => __('Feature-3 Icon', 'magista'),
            'section' => 'magista_features',
            'settings' => 'magista_features_icon_3',
            'priority' => 9,
        ));
        ...
        //new section video
        $wp_customize->add_section('magista_video', array(
            'title' => __('Video Settings', 'magista'),
            'priority' => 33,
        ));
        $wp_customize->add_setting('magista_video_check', array(
            'sanitize_callback' => 'magista_sanitize_checkbox',
            'transport' => 'postMessage',
        ));

        $wp_customize->add_control('magista_video_check', array(
            'label' => __('Show Video on your Front Page', 'magista'),
            'section' => 'magista_video',
            'settings' => 'magista_video_check',
            'priority' => 1,
            'type'=>'checkbox',
        ));
