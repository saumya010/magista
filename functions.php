...
// load Magista styles
	...
	wp_enqueue_script('magista-navscroller', get_template_directory_uri().'/includes/js/jquery.min.js', array('jquery'), true);
       	wp_enqueue_script('magista-flex', get_template_directory_uri().'/includes/js/jquery.flexslider.js', array('jquery') );
	...
	wp_enqueue_script('magista-scroll', get_template_directory_uri().'/includes/js/scrollReveal.js', array('jquery'), true);
	wp_enqueue_script('magista-scroller', get_template_directory_uri().'/includes/js/scr.js', array('jquery'), true);
	wp_enqueue_script('magista-navscroller1', get_template_directory_uri().'/includes/js/jquery.smint.js', array('jquery'), true);
